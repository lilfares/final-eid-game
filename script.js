...
function sendmail(name, email, partnerInfo) {
    ...
    <div dir="rtl">
        مرحبا ${name} 👋<br><br>
        🎁 لديك رسالة سرية بخصوص العيد! افتح البريد لمعرفة التفاصيل. 🤫✨<br><br>
        -------<br><br>
        ✨ شريكك السري هو: ${partnerInfo} ✨<br><br>
        📝 <strong>ملاحظة:</strong> <br><br>
        - لا تخبر أحدًا! دَعها مفاجأة حتى يوم العيد! 😏🎉<br><br>
        - ابقَ مستعدًا للمفاجآت! 🎉<br><br>
        🎉 <strong>نتمنى لك عيدًا سعيدًا!</strong> 🎉
    </div>
    `;
